...
```
============================================================
MCP Custom Headers - Workshop Server Demo
============================================================
...
------------------------------------------------------------
✓ Connected to: Workshop MCP Server
✓ Session ID: abc123...
...
📥 Response: Found 3 tools:
   ...
   • check_Path_conditions: Check current conditions...
...
- [MCP Security Workshop](https://aka.ms/Workshop)
