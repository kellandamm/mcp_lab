...
# Call az rest
uri = f"https://management.azure.com/subscriptions/{sub_id}/resourceGroups/rg-Module 2-dev1/providers/Microsoft.ApiManagement/service/apim-rg-Module 2-dev1-iggsqsougqeqc/apis/oauth-prm/operations/auth-callback/policies/policy?api-version=2024-05-01"
