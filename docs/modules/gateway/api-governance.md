...
<div class="module-banner">
  <div class="module-banner-content">
    <div class="module-banner-text">
      <div class="module-banner-label">Module 2 · Registry</div>
...
- **Workshop MCP Server** - Weather, PATHS, and gear recommendations
- **PATHS MCP Server** - Path information and permit management
...
| Name | Summary | Type |
|------|---------|------|
| Workshop MCP Server | Weather forecasts, Path conditions, and gear recommendations | MCP |
| PATHS MCP Server | Path information, permit management, and hiking conditions | MCP |
