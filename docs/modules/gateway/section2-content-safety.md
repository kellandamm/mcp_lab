...
<div class="module-banner">
  <div class="module-banner-content">
    <div class="module-banner-text">
      <div class="module-banner-label">Module 2 · Prompt Shields</div>
...
| Workshop MCP Server | Receives only clean, authenticated requests |
...
???+ note "Step 1: Understand the Risk - Prompt Injection Attacks"
    ...
    Your Workshop MCP Server is deployed with OAuth and rate limiting from Section 1, but there's no content filtering. This leaves it vulnerable to **prompt injection attacks**.
