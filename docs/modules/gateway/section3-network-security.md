...
<div class="module-banner">
  <div class="module-banner-content">
    <div class="module-banner-text">
      <div class="module-banner-label">Module 2 · Network Isolation</div>
...
???+ note "Understanding Network Isolation for MCP Servers"
    ...
    **Anyone who discovers your Container App URL can bypass APIM entirely.**
    ...
    ```
    https://Workshop-mcp-server.xxxxxxx.xxxxx.azurecontainerapps.io
    ```
...
When you're done with Module 2, remove all Azure resources:
...
!!! warning "This deletes everything"
    The `azd down` command will delete all Azure resources provisioned for this module, including the APIM gateway, Container Apps, Content Safety, and API Center. Make sure you've completed all the waypoints you want to explore before running cleanup.
...
[Continue: Module 3 →](../io-security/index.md){ .md-button .md-button--primary }

← [Content Safety](section2-content-safety.md) | [Module 3: I/O Security →](../io-security/index.md)
